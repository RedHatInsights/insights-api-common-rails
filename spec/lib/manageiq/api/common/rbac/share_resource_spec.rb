describe ManageIQ::API::Common::RBAC::ShareResource do
  ...
  context "invalid group uuid" do
    ...
    it "raises exception if group id is invalid" do
      ...
      allow(ManageIQ::API::Common::RBAC::Service).to receive(:paginate).with(api_instance, :list_roles, pagination_options).and_return(roles)
