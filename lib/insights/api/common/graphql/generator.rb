      ...
      module GraphQL
        module Generator
          ...
          def self.init_schema(request, schema_overlay = {})
            init_schema_general(request, { :use_pagination_v2 => false }, schema_overlay)
          end

          def self.init_schema_v2(request, schema_overlay = {})
            init_schema_general(request, { :use_pagination_v2 => true }, schema_overlay)
          end

          def self.init_schema_general(request, graphql_options, schema_overlay = {})
