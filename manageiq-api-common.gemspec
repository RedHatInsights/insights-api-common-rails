...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{Header, Encryption, RBAC, Serialization, Pagination and other common behavior for microservices}
  ...
  spec.add_runtime_dependency "openapi_parser",      "~> 0.5.0"
